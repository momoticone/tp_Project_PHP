...
<body>
    <div class="container">
        ...
        ?>
                <!-- modifier le chemin acces " /router.php/ajouter-produit"  en "/PHP-Cours/produit-crud/router.php/catalogue"-->
        <form method="POST" action="/PHP-Cours/produit-crud/router.php/catalogue" enctype="multipart/form-data" class="p-5">
